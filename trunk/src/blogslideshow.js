...
bsShow.prototype = {
	...
	init : function() {
        ...
        checkDependencies : function() {
            if (undefined == tEffect) {
                throw new Exception("Cannot find dependency - Transiton Effect library");
            }
            if (undefined == aQueue) {
                throw new Exception("Cannot find dependency - Asynchronous Queue library");
            }
        },
	...
	renderUI : function(href) {
            ...
            this.maskNode = $('ss-mask'); // freezeNode
            ...
            this.imageNode = $('ss-image'); // subjectImageNode
            this.spriteNode = $('ss-sprite'); // overlayImageNode
            this.eOverlayNode = $('ss-effect-overlay'); // overlayMaskNode
